Note: You need to have a working copy of java to use aterm.jar.
...
If you wish to automate the script please contact the servicedesk who will explain how to obtain a generic account for this purpose.

Step 3: upload or download data
-------
